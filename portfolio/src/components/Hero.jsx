                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    <div className="lg:col-span-8">
                        <motion.h1
                            ...
                            className="text-[14vw] md:text-8xl lg:text-[10rem] font-black tracking-tighter leading-[0.85] mb-8"
                        >
                            ASEEM <br />
                        ...
                        <motion.p
                            ...
                            className="text-lg md:text-2xl text-gray-400 font-light max-w-xl mb-12 leading-relaxed"
                        >
                        ...
                        >
                            <a href="https://github.com/aseemaslah" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors"><Github size={28} /></a>
                            <a href="https://www.linkedin.com/in/aseem-aslah" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors"><Linkedin size={28} /></a>
                            <a href="https://www.instagram.com/_asim_aslh__" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors"><Instagram size={28} /></a>
                        </motion.div>
                    </div>
