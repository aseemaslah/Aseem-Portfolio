...
const Footer = () => {
    return (
        <footer className="py-20 bg-black text-gray-500 border-t border-gray-900 overflow-hidden relative">
            <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row justify-between items-center text-xs md:text-sm font-mono uppercase tracking-widest gap-8 md:gap-0">
