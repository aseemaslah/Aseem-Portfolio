...
const About = () => {
    return (
        <section id="about" className="py-20 sm:py-24 md:py-48 lg:py-72 bg-black text-white px-4 sm:px-6 relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-24 items-start">
                    ...
                    >
                        <h2 className="text-xs sm:text-sm font-mono text-gray-500 uppercase tracking-widest mb-4">Who I Am</h2>
                        <div className="w-10 sm:w-12 h-[1px] bg-white/20 mb-6 sm:mb-8"></div>
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-serif italic text-gray-300 leading-tight">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="lg:col-span-8 lg:pl-12 text-base sm:text-lg md:text-2xl font-light leading-relaxed text-gray-400 space-y-6 sm:space-y-8"
                    >
                        <p>
                        ...
                        <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row gap-6 sm:gap-8 text-xs sm:text-sm font-mono tracking-wider text-white">
                            <div>
