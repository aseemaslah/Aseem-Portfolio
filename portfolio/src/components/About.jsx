...
const About = () => {
    return (
        <section id="about" className="py-24 md:py-48 lg:py-72 bg-black text-white px-6 relative">
            ...
            <div className="container mx-auto max-w-6xl">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
                    ...
                    >
                        ...
                        <h3 className="text-3xl md:text-4xl font-serif italic text-gray-300 leading-tight">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="lg:col-span-8 lg:pl-12 text-lg md:text-2xl font-light leading-relaxed text-gray-400 space-y-8"
                    >
                        <p>
                        ...
                        <div className="pt-8 flex flex-col sm:flex-row gap-8 text-sm font-mono tracking-wider text-white">
                            <div>
